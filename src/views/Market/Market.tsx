...
import { Box, useMediaQuery, SvgIcon, Tooltip, Dialog } from "@material-ui/core";
  ...
  return (
    <div id="market-view" onScroll={scrollHandler}>
      ...
      >
        ...
        >
          <div className="title">{t`META BITCOIN NFT`}</div>
          <div className="desc">{t`NFT Miner mines MBTC by providing hash power using proof-of-NFT`}</div>
          <div className="msg-view">
            ...
            <div className="msg-item">
              ...
              <div className="msg-item-right">
                ...
                <div className="msg-item-desc">{t`Volume traded`}</div>
              </div>
            </div>
          </div>
        </div>
      ...
      >
        ...
        >
          <div className="btc-card-box" style={{ justifyContent: "center" }}>
            {nftList.map(item => {
              return (
                <div
      ...
      >
        <div style={{ padding: "1rem", textAlign: "center", fontSize: "1.2rem" }}>
          {t`The market is temporarily closed.`}
        </div>
      </Dialog>
    </div>
  );
